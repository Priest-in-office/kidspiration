      ...
      <div className="flex flex-col justify-center items-center gap-8 px-4 py-20 lg:py-32 bg-background-light dark:bg-background-dark relative overflow-hidden">
        ...
        <div className="flex flex-col gap-4 text-center max-w-2xl z-10">
          ...
          <p className="text-text-muted text-lg font-normal leading-relaxed dark:text-stone-300">
            Join thousands of other families in the Kidspiration community
            today. It's safe, fun, and free to explore!
          </p>
        </div>
        <div className="flex w-full justify-center z-10">
          <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-primary text-stone-900 text-lg font-bold shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/40 hover:-translate-y-1 transition-all duration-300">
