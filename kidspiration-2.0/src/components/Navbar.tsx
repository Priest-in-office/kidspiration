      ...
      <div className="flex items-center justify-between whitespace-nowrap px-4 md:px-10 py-4">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              className="text-slate-700 dark:text-slate-300 hover:text-primary transition-colors text-sm font-bold"
              href="#"
            >
              Home
            </a>
          ...
          <label className="hidden lg:flex flex-col min-w-40 h-10 w-64">
            <div className="flex w-full flex-1 items-stretch rounded-xl h-full bg-slate-100 dark:bg-slate-800 focus-within:ring-2 focus-within:ring-primary transition-all">
              ...
              <input
                ...
                placeholder="Search fun stuff..."
              />
            </div>
          </label>

          {/* Join Now - desktop only */}
          <button className="hidden md:flex items-center justify-center rounded-xl h-10 px-5 bg-primary hover:bg-primary-dark transition-colors text-slate-900 text-sm font-bold tracking-wide shadow-sm">
            <span>Join Now</span>
          </button>
